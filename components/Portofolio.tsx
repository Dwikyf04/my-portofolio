      ...
      <div className="wrapper-porto">
        <div className="product_box">
          ...
          <div className="description">
            ...
            <p>
              - Performing text mining and natural language processing (NLP) on
              a novel using Orange Data Mining, applying the Word Cloud,
              Similarity Hashing, K-Means, Hierarchical Clustering, and T-SNE
              methods.
            </p>
            <p>
              - Processing and analyzing over 200 pages and 35 chapters of text
              data, building a clustering model to identify similarities between
              chapters.
            </p>
            <div className="button-porto">
              <a
        ...
        <div className="product_box">
          ...
          <div className="description">
            ...
            <h3>
              Predict Persebaya match outcomes in Indonesia Liga 1 (2019–2025).
            </h3>
            <p>
              Research on digital preservation and data management in libraries.
            </p>
            <div className="button-porto">
              <a
        ...
        <div className="product_box">
          ...
          <div className="description">
            ...
            <p>
              Analyzed and processed datasets of over 50,000 records, using SQL
              to extract actionable insights and presenting findings through
              interactive dashboards to improve decision-making.
            </p>
            <p>
              Collaborated with a team of 10+ participants to solve real-world
              data problems, achieving a 90% accuracy rate in project
              deliverables and contributing to a 25% improvement in overall team
              performance.
            </p>
            <div className="button-porto">
              <a
        ...
        <div className="product_box">
          ...
          <div className="description">
            ...
            <p>
              ...
              Scikit-learn to provide personalized book recommendations based on
              user preferences.
            </p>
            <p>
        ...
        <div className="product_box">
          ...
          <div className="description">
            ...
            <p>
              ...
              Python to accurately classify various denominations of Indonesian
              Rupiah banknotes.
            </p>
            <p>
              Integrated Text-to-Speech (TTS) functionality to provide immediate
              auditory feedback, enabling users to identify currency values
              through voice output.
            </p>
            <div className="button-porto">
              <a
                href="hhttps://deteksi-matauang-rupiah-ejepe3snna3edjls7t2dnk.streamlit.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span>Portofolio</span>
        ...
        <div className="product_box">
          ...
          <div className="description">
            ...
            <h3>Portofolio Project</h3>
            <p>
              Designed a modern and responsive User Interface (UI) using Figma,
              focusing on clean layout, visual hierarchy, and intuitive user
              experience (UX).
            </p>
            <div className="button-porto">
              <a
